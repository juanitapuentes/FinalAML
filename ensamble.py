...
def eval(model, device, loader, num_classes, args):
    ...
    test_model_path1 = test_model_path + "Pretrained-Model/Fold1/model_ckpt/BS_2560-NF_full_valid_best.pth"
    test_model_path2 = test_model_path + "Pretrained-Model/Fold2/model_ckpt/BS_2560-NF_full_valid_best.pth"
    test_model_path3 = test_model_path + "Pretrained-Model/Fold3/model_ckpt/BS_2560-NF_full_valid_best.pth"
    test_model_path4 = test_model_path + "Pretrained-Model/Fold4/model_ckpt/BS_2560-NF_full_valid_best.pth"
